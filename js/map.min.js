...
(function ($) {
    ...
    var map, mapdata = $('#map'), latlng = mapdata.data('latlng'), latlngStr = latlng.replace(/\s+/g, '').split(",", 2), lat = parseFloat(latlngStr[0]), lng = parseFloat(latlngStr[1]), zoomfactor = mapdata.data('zoom'), markerurl = mapdata.data("marker"), image;
